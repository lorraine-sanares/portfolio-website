...
const Projects: React.FC = () => {
    return (
        <div className="flex flex-col items-start justify-start w-full h-auto p-28 gap-16">
            ...
            <div className="relative flex flex-row w-full h-[500px] rounded-3xl bg-white p-10 text-start bg-opacity-80 backdrop-blur-md">
                {/* Left: Text Content */}
            ...
            {/* Bookstore Analysis */}
            <div className="flex flex-row w-full h-[500px] rounded-3xl bg-white p-10 text-start bg-opacity-80 backdrop-blur-md">
                {/* Left: Text Content */}
                <div className="flex flex-col w-1/2 h-auto items-start justify-center">
